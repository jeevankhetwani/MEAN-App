...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__guards_guard_service__ = __webpack_require__("../../../../../src/app/guards/guard.service.ts");
...
var appRoutes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_7__components_dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_guard_service__["a" /* AuthGuard */]] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_8__components_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_guard_service__["a" /* AuthGuard */]] },
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_11__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_14__services_register_service__["a" /* RegisterService */], __WEBPACK_IMPORTED_MODULE_15__guards_guard_service__["a" /* AuthGuard */]],
...
var LoginComponent = (function () {
    function LoginComponent(router, flashService, registerService) {
        this.router = router;
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        var _this = this;
        this.registerService.authenticate(this.user)
            .subscribe(function (data) {
            if (data.success) {
                _this.registerService.storeUserData(data.token, data.user);
                _this.flashService.show('You are logged in', {
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_angular2_flash_messages__["FlashMessagesService"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__services_register_service__["a" /* RegisterService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_register_service__["a" /* RegisterService */]) === "function" && _c || Object])
], LoginComponent);
...
var NavBarComponent = (function () {
    function NavBarComponent(router, flashService, registerService) {
        this.router = router;
        this.flashService = flashService;
        this.registerService = registerService;
    }
    NavBarComponent.prototype.onLogout = function () {
        ...
        this.flashService.show('You are logged out', {
            cssClass: 'alert-success',
            timeout: 3000
        });
...
var ProfileComponent = (function () {
    function ProfileComponent(registerService) {
        this.registerService = registerService;
    }
    ProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.registerService.getProfile()
            .subscribe(function (data) { return _this.user = data.user; }, function (err) {
            console.log(err);
            return false;
        });
    };
...
var RegisterComponent = (function () {
    function RegisterComponent(registerService, router, flashService) {
        this.registerService = registerService;
        this.router = router;
        this.flashService = flashService;
        this.user = {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        var _this = this;
        return this.registerService.register(this.user)
            .subscribe(function (data) {
            if (data.success) {
                _this.flashService.show('You are now registered', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashService.show('failed to register', { cssClass: 'alert-danger', timeout: 3000 });
...
var AuthGuard = (function () {
    function AuthGuard(registerService, router) {
        this.registerService = registerService;
        this.router = router;
    }
...
var RegisterService = (function () {
    ...
    RegisterService.prototype.authenticate = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/authenticate', user, { headers: headers }).
            map(function (res) { return res.json(); });
    };
    RegisterService.prototype.getProfile = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        this.loadToken();
        headers.append('Content-Type', 'application/json');
    ...
    RegisterService.prototype.storeUserData = function (token, user) {
